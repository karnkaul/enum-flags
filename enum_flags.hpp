...
struct enum_flags {
	...
	///
	constexpr reference operator[](Enum flag) noexcept;
	///
...
template <typename Enum, std::size_t N>
constexpr typename enum_flags<Enum, N>::reference enum_flags<Enum, N>::operator[](Enum flag) noexcept {
